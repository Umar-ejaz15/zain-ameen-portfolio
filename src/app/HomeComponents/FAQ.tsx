  ...
  const faqs = [
    {
      ...
      answer: "Both. I specialize in SaaS products (like Blainy - ~85K users) and service businesses (like Everdry Waterproofing). Same growth principles. Different execution.",
    },
    {
      question: "How fast can I see results?",
      answer: "Reddit and social can generate leads in 30 days. SEO takes 60-90 days for momentum. I focus on sustainable growth, not quick hacks that die.",
    },
    {
      question: "Can you replicate the ~85K users result?",
      answer: "Every business is different. But I use the same systems: multi-channel SEO, Reddit marketing, social media, email campaigns. The framework scales.",
    },
    {
      question: "What makes Reddit marketing work?",
      answer: "Authenticity. I don't spam. I build community trust. Value-first content. Non-promotional engagement. That's why I've generated thousands of users with $0 ad spend.",
    },
    {
      question: "Do you handle paid ads too?",
      answer: "Yes. Meta Ads, Google Ads, retargeting. But my strength is organic growth. Lower CAC. Better retention. Sustainable over time.",
    },
    {
      question: "What's your pricing?",
      answer: "Depends on scope. SaaS projects differ from service businesses. Book a free call and I'll create a custom proposal.",
    },
    {
      question: "Can you work remotely?",
      answer: "Absolutely. I've worked with clients across US, Europe, Asia. Remote is my default.",
    },
    {
      question: "What if I need just SEO or just Reddit?",
      answer: "No problem. I offer individual services or full-stack growth. We'll figure out what you need.",
    },
  ];
